...
storiesOf('Component/ItemEditor', module)
  ...
  .add('ItemEditor on inventories with no selection', () => <Test><ItemEditor name="inventory" /></Test>)
  .add('ItemEditor on requests', () => <Test><ItemEditor name="request" index={1}/></Test>)
  .add('ItemEditor on requests with no selection', () => <Test><ItemEditor name="request" /></Test>)
